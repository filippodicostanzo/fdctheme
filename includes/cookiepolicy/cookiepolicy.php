<div id="cookie" style="display:none;">
    ...
    <p>L'utilizzo di cookie da parte del Titolare di questo sito, <?=get_bloginfo( 'name' );?>, si inquadra nella Privacy Policy dello stesso; per tutte le informazioni richieste dall'art. 13 Codice della Privacy clicca visita l'apposita pagina di questo sito web.</p>
    ...
    <table>
        <tbody>
        <tr>
            <th colspan="2"><p>Cookie di prima parte, ossia rilasciati da <?=$_SERVER['SERVER_NAME']?></p></th>
        </tr>
        <tr>
        ...
        <tr>
            <th colspan="2"><p>Cookie di terze parti, ossia rilasciati da siti diversi rispetto a <?=$_SERVER['SERVER_NAME']?></p></th>
        </tr>
        <tr>
            <th><p>Tipologia di Cookie</p></th>
            <th><p>Che cosa fanno?</p></th>
    ...
    <p><?=$_SERVER['SERVER_NAME']?> utilizza cookie allo scopo di memorizzare la lingua dell'utente e poter proporre allo stesso di default la versione del sito (italiana o inglese) in base alle sue preferenze di navigazione.</p>
    <!--END Local_Language -->
    <!--BEGIN Local_TextSize -->
    <p><?=$_SERVER['SERVER_NAME']?> utilizza cookie allo scopo di memorizzare la dimensione del carattere preferito dall'utente e poter proporre allo stesso la stessa dimensione ad ogni visita in base alle sue preferenze di navigazione.</p>
    <!--END Local_TextSize -->
    <!--END Local -->
    <!--BEGIN Other -->
    <h4>Cookie di terze parti</h4>
    <p>Navigando su questo sito riceverete sia cookie di <?=get_bloginfo( 'name' );?>, sia cookie da siti di terze parti, i quali potranno impostare cookie sul vostro dispositivo per nostro conto al fine di erogare i servizi che stanno fornendo.</p>
    ...
    <p><?=$_SERVER['SERVER_NAME']?> utilizza Google Analytics, un servizio di analisi del traffico web fornito da Google, Inc., 1600 Amphitheatre Parkway - Mountain View - CA94043 USA, che fa uso di cookie per raccogliere ed analizzare in forma aggregata informazioni relative alla navigazione degli utenti. N&eacute; <?=get_bloginfo( 'name' );?> n&eacute; Google associano il vostro indirizzo IP ad altri dati in loro possesso per identificarvi direttamente.</p>
    <p>Le informazioni raccolte vengono elaborate dai sistemi di Google Analytics allo scopo di produrre report per gli amministratori di <?=$_SERVER['SERVER_NAME']?>, che li utilizzano per verificare il corretto funzionamento dei servizi ed eventualmente il tasso di gradimento dei contenuti proposti.</p>
    ...
    <p><?=$_SERVER['SERVER_NAME']?> utilizza Shareaholic, un servizio di condivisione dei contenuti sui maggiori social network fornito da Shareaholic, Inc., 109 Kingston Street, 4th Floor, Boston, MA02111 USA, che fa uso di specifici cookie per la gestione dell'accesso ai social network e delle proprie campagne pubblicitarie.</p>
    ...
    <p><?=$_SERVER['SERVER_NAME']?> utilizza Disqus, un servizio che consente di raccogliere commenti ai contenuti presenti su questo sito web fornito da Disqus, Inc., 301 Howard Street, Suite 300, San Francisco, CA94105 USA, che fa uso di specifici cookie per la gestione dell'accesso.</p>
